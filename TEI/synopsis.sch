...
<sch:schema xmlns:sch="http://www.ascc.net/xml/schematron">
    ...
    <sch:pattern name="Structure">
        <sch:rule context="tei:add">
            <sch:assert test="parent::tei:orig or parent::tei:rdg or parent::tei:subst">Invalid parent for add</sch:assert>
        ...
        <sch:rule context="tei:corr">
            ...
            <sch:assert test="count(*) = count(tei:choice | tei:hi | tei:w | tei:space)">Invalid element inside corr (valid: choice, hi, w)</sch:assert>
        </sch:rule>
        ...
        <sch:rule context="tei:damage">
            <sch:assert test="parent::tei:orig | parent::tei:rdg">Invalid parent for damage (valid: orig, rdg)</sch:assert>
        ...
        <sch:rule context="tei:lb">
            <sch:assert test=" parent::tei:del | parent::tei:rdg | parent::tei:hi">Invalid parent for lb (valid: del, rdg, hi)</sch:assert>
        ...
        <sch:rule context="tei:metamark">
            <sch:assert test=" parent::tei:add | parent::tei:rdg | parent::tei:hi | parent::tei:orig">Invalid parent for metamark (valid: add, rdg, hi, orig)</sch:assert>
            <sch:assert test="count(@*) = 0 or @function='cue_initial' or @function='addition'">Invalid attribute for metamark (valid: @function='cue_initial' o 'addition')</sch:assert>
        ...
        <sch:rule context="tei:orig">
            ...
            <sch:assert test="count(*) = count(tei:choice | tei:damage | tei:del | tei:hi |tei:metamark | tei:sic | tei:subst | tei:unclear)">Only choice, damage, del, hi, metamark, sic, subst and unclear allowed as children of orig</sch:assert>
        </sch:rule>
        ...
        <sch:rule context="tei:rdg">
            <sch:assert test="count(*) = count(tei:add | tei:choice | tei:damage | tei:del | tei:gap | tei:hi | tei:lb | tei:metamark | tei:note | tei:pc | tei:space | tei:subst | tei:w | tei:witEnd | tei:witStart)">Only add, choice, damage, del, gap, hi, lb, pc, space, subst, note, metamark, w, witEnd, witStart allowed as children of rdg</sch:assert>
        </sch:rule>
        <sch:rule context="tei:sic">
            ...
            <sch:assert test="count(*) = count(tei:choice | tei:hi | tei:w | tei:space | tei:unclear)">Invalid element inside sic (valid: choice, hi, w)</sch:assert>
        </sch:rule>
        ...
        <sch:rule context="tei:space">
            <sch:assert test="parent::tei:add or parent::tei:rdg or parent::tei:hi or parent::tei:del or parent::tei:sic or parent::tei:subst">The element space must have add, del, hi, rdg, sic or subst for parent</sch:assert>
        ...
        <sch:rule context="tei:supplied">
            <sch:assert test="parent::tei:orig | parent::tei:rdg">Invalid parent for supplied (valid: orig, rdg)</sch:assert>
            <sch:assert test="count(@*) = count(@resp)">Invalid attribute for supplied (valid: @resp)</sch:assert>
            <sch:assert test="count(*) = count(tei:w | tei:pc | text())">Invalid element inside supplied (valid: pc, w or text-node)</sch:assert>
        </sch:rule>
        ...
        <sch:rule context="tei:witEnd">
            ...
            <sch:assert test="count(@*) = 0">witEnd can't have any attributes</sch:assert>
        ...
        <sch:rule context="tei:witStart">
            ...
            <sch:assert test="count(@*) = 0">witStart can't have any attributes</sch:assert>
